...
SELECT common_name FROM melons WHERE common_name like '%Golden' OR common_name like '%Golden%' OR common_name like 'Golden%';
...
SELECT melon_type, common_name, price, price*.73 AS price_in_Euros FROM melons;;
...
SELECT o.id, status, order_total
	FROM orders AS o
		JOIN customers AS c
